...
namespace Tokki.UnitTest.Application.UseCases.MiniGame.Queries.Wordle
{
    public class GetWordleResultHandlerTests
    {
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-MIG-GWR-01 | A | Progress Is Null -> Fail
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-MIG-GWR-02 | A | Progress IsWon False -> Fail
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_ProgressIsWonFalse_ShouldReturnFailure()
        {
            ...
            result.IsSuccess.Should().BeFalse();
            result.Message.Should().Contain("chiến thắng trò chơi");

            QACollector.LogTestCase("MiniGame - Get Wordle Result", new TestCaseDetail
            {
                FunctionGroup = "GetWordleResultHandler",
                TestCaseID = "TC-MIG-GWR-02",
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-MIG-GWR-03 | A | Game Null -> Fail
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_GameNull_ShouldReturnFailure()
        {
            ...
            result.IsSuccess.Should().BeFalse();
            result.Message.Should().Contain("Không tìm thấy thông tin trò chơi");

            QACollector.LogTestCase("MiniGame - Get Wordle Result", new TestCaseDetail
            {
                FunctionGroup = "GetWordleResultHandler",
                TestCaseID = "TC-MIG-GWR-03",
                Description = "Prevents corrupt states propagating mapping object safely throwing early logically",
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-MIG-GWR-04 | N | Completely Success Path maps securely fully nested object
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-MIG-GWR-05 | N | Missing Visuals fallback safely empty strings
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-MIG-GWR-06 | N | Verify Request Values strictly bind Database query calls
        // ═══════════════════════════════════════════════════════════
        [Fact]
