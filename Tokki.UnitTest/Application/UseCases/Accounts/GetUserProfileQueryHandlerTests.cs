...
namespace Tokki.UnitTest.Application.UseCases.Accounts
{
    public class GetUserProfileQueryHandlerTests
    {
        ...
        // ═══════════════════════════════════════════════════════════
        // Get_User_Profile_01 | A | UserId not found → 404
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_UserNotFound_ShouldReturn404()
        {
            ...
            QACollector.LogTestCase("Account - Get User Profile", new TestCaseDetail
            {
                ...
                TestCaseID      = "Get_User_Profile_01",
        ...
        // ═══════════════════════════════════════════════════════════
        // Get_User_Profile_02 | N | Valid UserId → 200 with profile DTO
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_ValidUser_ShouldReturn200WithProfileDto()
        {
            ...
            {
                FunctionGroup   = "Get User Profile",
                TestCaseID      = "Get_User_Profile_02",
        ...
        // ═══════════════════════════════════════════════════════════
        // Get_User_Profile_03 | B | Account with null DateOfBirth → DateOfBirth = null in DTO
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_NullDateOfBirth_ShouldReturnNullInDto()
        {
            ...
            {
                FunctionGroup   = "Get User Profile",
                TestCaseID      = "Get_User_Profile_03",
        ...
        // ═══════════════════════════════════════════════════════════
        // Get_User_Profile_04 | N | Account with DateOfBirth set → correctly converted to DateOnly
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_AccountWithDateOfBirth_ShouldConvertToDateOnly()
        {
            ...
            {
                FunctionGroup   = "Get User Profile",
                TestCaseID      = "Get_User_Profile_04",
        ...
        // ═══════════════════════════════════════════════════════════
        // Get_User_Profile_05 | N | Account without AvatarUrl → AvatarUrl is null in DTO
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_NoAvatarUrl_ShouldReturnNullAvatarInDto()
        {
            ...
            {
                FunctionGroup   = "Get User Profile",
                TestCaseID      = "Get_User_Profile_05",
        ...
        // ═══════════════════════════════════════════════════════════
        // Get_User_Profile_06 | N | Admin account profile → Role mapped as Admin
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_AdminAccount_ShouldReturnAdminRoleInDto()
        {
            ...
            {
                FunctionGroup   = "Get User Profile",
                TestCaseID      = "Get_User_Profile_06",
