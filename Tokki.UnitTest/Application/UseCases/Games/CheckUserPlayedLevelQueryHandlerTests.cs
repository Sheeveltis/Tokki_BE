...
namespace Tokki.UnitTest.Application.UseCases.Games
{
    public class CheckUserPlayedLevelQueryHandlerTests
    {
        ...
        // ═══════════════════════════════════════════════════════════════════
        // TC-GAME-CPL-01 | 401 | No userId in token → Unauthorized
        // ═══════════════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════════════
        // TC-GAME-CPL-02 | 200 | Session exists → hasPlayed = true
        // ═══════════════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════════════
        // TC-GAME-CPL-03 | 200 | Session null → hasPlayed = false
        // ═══════════════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════════════
        // TC-GAME-CPL-04 | 200 | Different topic same game → hasPlayed = false
        // ═══════════════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_DifferentTopicSameGame_ShouldReturnFalse()
        {
            // Session exists for TOPIC-001 but query is for TOPIC-002
            var mockSessionRepo = new Mock<IGameMatchSessionRepository>();
            mockSessionRepo.Setup(x => x.GetByUserGameTopicAsync(
        ...
        // ═══════════════════════════════════════════════════════════════════
        // TC-GAME-CPL-05 | 200 | Different difficulty → hasPlayed = false
        // ═══════════════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_DifferentDifficulty_ShouldReturnFalse()
        {
            // User played Easy but query is for Hard
            var mockSessionRepo = new Mock<IGameMatchSessionRepository>();
            mockSessionRepo.Setup(x => x.GetByUserGameTopicAsync(
        ...
        // ═══════════════════════════════════════════════════════════════════
        // TC-GAME-CPL-06 | 500 | Repository throws → ServerError
        // ═══════════════════════════════════════════════════════════════════
        [Fact]
