...
namespace Tokki.UnitTest.Application.UseCases.Roadmap
{
    public class SubmitExamCommandHandlerTests
    {
        ...
        // TC-RM-SBE-01 | A | No exam questions → 404
        [Fact]
        public async Task Handle_NoExamQuestions_ShouldReturn404()
        {
            ...
            QACollector.LogTestCase("Roadmap - Submit Exam", new TestCaseDetail { FunctionGroup = "SubmitExam", TestCaseID = "TC-RM-SBE-01", Description = "No exam questions → 404", ExpectedResult = "IsSuccess=false, 404", StatusRound1 = "Passed", TestCaseType = "A", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "GetExamQuestionsForGradingAsync returns []" } });
        }

        // TC-RM-SBE-02 | N | Happy path: 1 correct answer → totalScore > 0, 200
        [Fact]
        public async Task Handle_OneCorrectAnswer_ShouldReturnPositiveScore()
        {
            ...
            QACollector.LogTestCase("Roadmap - Submit Exam", new TestCaseDetail { FunctionGroup = "SubmitExam", TestCaseID = "TC-RM-SBE-02", Description = "1 correct answer → Score=10, 200", ExpectedResult = "IsSuccess=true, Data=10", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "Correct answer submitted", "Score=10" } });
        }

        // TC-RM-SBE-03 | N | Wrong answer → score = 0
        [Fact]
        public async Task Handle_WrongAnswer_ShouldReturnZeroScore()
        {
            ...
            QACollector.LogTestCase("Roadmap - Submit Exam", new TestCaseDetail { FunctionGroup = "SubmitExam", TestCaseID = "TC-RM-SBE-03", Description = "Wrong answer → Score=0", ExpectedResult = "IsSuccess=true, Data=0", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "Wrong option selected", "Score=0" } });
        }

        // TC-RM-SBE-04 | N | Empty answers list → score = 0, success
        [Fact]
        public async Task Handle_EmptyAnswers_ShouldReturnZero()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            result.Data.Should().Be(0);
            QACollector.LogTestCase("Roadmap - Submit Exam", new TestCaseDetail { FunctionGroup = "SubmitExam", TestCaseID = "TC-RM-SBE-04", Description = "Empty answers → Score=0, success", ExpectedResult = "IsSuccess=true, Score=0", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "Answers=[]", "no grading", "Score=0" } });
        }

        // TC-RM-SBE-05 | B | AddUserExamAsync and AddUserExamAnswersAsync both called
        [Fact]
        public async Task Handle_ValidSubmit_ShouldCallAddUserExamAndAnswers()
        {
            ...
            QACollector.LogTestCase("Roadmap - Submit Exam", new TestCaseDetail { FunctionGroup = "SubmitExam", TestCaseID = "TC-RM-SBE-05", Description = "AddUserExamAsync and AddUserExamAnswersAsync both called once", ExpectedResult = "Both Times.Once", StatusRound1 = "Passed", TestCaseType = "B", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "UserExam and Answers persisted" } });
        }

        // TC-RM-SBE-06 | N | UserExam.Status = Completed after submission
        [Fact]
        public async Task Handle_ValidSubmit_UserExamStatusShouldBeCompleted()
        {
            ...
            QACollector.LogTestCase("Roadmap - Submit Exam", new TestCaseDetail { FunctionGroup = "SubmitExam", TestCaseID = "TC-RM-SBE-06", Description = "UserExam created with Status=Completed", ExpectedResult = "UserExam.Status=Completed", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "UserExamStatus.Completed set on creation" } });
        }
    }
}
