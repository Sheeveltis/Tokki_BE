...
namespace Tokki.UnitTest.Application.UseCases.Roadmap
{
    public class GenerateNextWeekCommandHandlerTests
    {
        ...
        // TC-RM-GNW-07 | N | HasExam evaluates scores and warning properly
        [Fact]
