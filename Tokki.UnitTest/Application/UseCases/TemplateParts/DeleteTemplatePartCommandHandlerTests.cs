...
namespace Tokki.UnitTest.Application.UseCases.TemplateParts
{
    public class DeleteTemplatePartCommandHandlerTests
    {
        ...
        // TC-TP-DEL-01 | A | Part not found → failure
        [Fact]
        ...
        public async Task Handle_PartFound_ShouldReturn200WithId()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Delete", new TestCaseDetail { FunctionGroup = "DeleteTemplatePart", TestCaseID = "TC-TP-DEL-02", Description = "Part found → 200, Data='TP-001'", ExpectedResult = "IsSuccess=true, 200, Data='TP-001'", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "Part exists and deleted" } });
        }

        // TC-TP-DEL-03 | B | DeleteAsync and SaveChangesAsync called once on success
        [Fact]
        ...
        public async Task Handle_PartFound_ReturnedIdMatchesRequest()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Delete", new TestCaseDetail { FunctionGroup = "DeleteTemplatePart", TestCaseID = "TC-TP-DEL-05", Description = "Returned ID='TP-XYZ' matches request", ExpectedResult = "Data='TP-XYZ'", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "ID echoed in response" } });
        }

        // TC-TP-DEL-06 | A | Repository throws → failure returned
        [Fact]
