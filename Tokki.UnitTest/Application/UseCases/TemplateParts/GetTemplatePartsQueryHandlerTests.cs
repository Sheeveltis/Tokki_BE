...
namespace Tokki.UnitTest.Application.UseCases.TemplateParts
{
    public class GetTemplatePartsQueryHandlerTests
    {
        ...
        // GetTemplateParts_01 | N | Happy path: 2 parts returned → PagedResult Count=2
        [Fact]
        public async Task Handle_RepoReturnsData_ShouldReturnPagedResult()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Get List", new TestCaseDetail { FunctionGroup = "GetTemplateParts", TestCaseID = "GetTemplateParts_01", Description = "2 parts returned → PagedResult Count=2, TotalCount=2", ExpectedResult = "IsSuccess=true, Items.Count=2", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "GetPagedAsync returns 2 items" } });
        }

        // GetTemplateParts_02 | N | TemplatePartDto fields mapped correctly
        [Fact]
        public async Task Handle_ReturnsData_DtoFieldsMappedCorrectly()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Get List", new TestCaseDetail { FunctionGroup = "GetTemplateParts", TestCaseID = "GetTemplateParts_02", Description = "TemplatePartDto fields correctly mapped from entity", ExpectedResult = "Id='TP-001', Skill=Listening, From=1, Mark=2", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "All DTO fields verified" } });
        }

        // GetTemplateParts_03 | N | QuestionType null → QuestionTypeName = 'Chưa phân loại'
        [Fact]
        public async Task Handle_PartHasNullQuestionType_QuestionTypeNameIsDefaultText()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Get List", new TestCaseDetail { FunctionGroup = "GetTemplateParts", TestCaseID = "GetTemplateParts_03", Description = "QuestionType=null → QuestionTypeName='Chưa phân loại'", ExpectedResult = "QuestionTypeName='Chưa phân loại'", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "Null nav property handled with default text" } });
        }

        // GetTemplateParts_04 | B | GetPagedAsync called with correct params
        [Fact]
        ...
        public async Task Handle_NoParts_ShouldReturn200WithEmptyPage()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Get List", new TestCaseDetail { FunctionGroup = "GetTemplateParts", TestCaseID = "GetTemplateParts_05", Description = "No parts → 200 with empty paged result", ExpectedResult = "IsSuccess=true, Items=[], TotalCount=0", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "No template parts exist" } });
        }

        // GetTemplateParts_06 | N | Paged metadata (PageNumber, PageSize, TotalCount) correct
        [Fact]
        public async Task Handle_WithTotalCount50_PagingMetadataCorrect()
        {
            ...
            QACollector.LogTestCase("TemplatePart - Get List", new TestCaseDetail { FunctionGroup = "GetTemplateParts", TestCaseID = "GetTemplateParts_06", Description = "Paging metadata: Page=3, Size=10, TotalCount=50", ExpectedResult = "Metadata correct", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "TotalCount=50, page 3 of 10" } });
        }
    }
}
