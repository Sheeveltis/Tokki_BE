...
namespace Tokki.UnitTest.Application.UseCases.Comments
{
    public class GetCommentsQueryHandlerTests
    {
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-CMG-01 | N | Empty blog → empty list, 200
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-CMG-02 | N | Root comments are returned at top level
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-CMG-03 | N | Replies are nested under parent
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-CMG-04 | N | Deleted comments show masked content
        // ═══════════════════════════════════════════════════════════
        [Fact]
        public async Task Handle_DeletedComment_ShouldShowMaskedContent()
        {
            ...
            // Assert
            result.Data.First().Content.Should().Contain("đã bị xóa");
            result.Data.First().IsDeleted.Should().BeTrue();

            QACollector.LogTestCase("Comment - Get", new TestCaseDetail
            {
                FunctionGroup     = "Get Comments",
                TestCaseID        = "TC-CMG-04",
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-CMG-05 | A | Reply with orphan ParentId goes to top level
        // ═══════════════════════════════════════════════════════════
        [Fact]
        ...
        // ═══════════════════════════════════════════════════════════
        // TC-CMG-06 | A | Repository throws exception → bubbles up
        // ═══════════════════════════════════════════════════════════
        [Fact]
