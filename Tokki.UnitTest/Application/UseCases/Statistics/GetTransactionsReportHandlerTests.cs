...
namespace Tokki.UnitTest.Application.UseCases.Statistics
{
    public class GetTransactionsReportHandlerTests
    {
        ...
        // GetTransactionsReport_01 | N | Happy path: 2 transactions returned → PagedResult count=2
        [Fact]
        public async Task Handle_RepoReturnsData_ShouldReturnPagedResult()
        {
            ...
            QACollector.LogTestCase("Statistics - Transactions Report", new TestCaseDetail { FunctionGroup = "GetTransactionsReport", TestCaseID = "GetTransactionsReport_01", Description = "2 transactions → PagedResult Count=2, TotalCount=2", ExpectedResult = "IsSuccess=true, Items.Count=2", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "GetTransactionsAsync returns 2 items" } });
        }

        // GetTransactionsReport_02 | N | Transaction fields (TransactionId, FullName, Amount, Status) mapped correctly
        [Fact]
        public async Task Handle_ReturnsData_TransactionFieldsMappedCorrectly()
        {
            ...
            QACollector.LogTestCase("Statistics - Transactions Report", new TestCaseDetail { FunctionGroup = "GetTransactionsReport", TestCaseID = "GetTransactionsReport_02", Description = "TX-999 fields mapped: Amount=1234, Status=Success", ExpectedResult = "All fields correct", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "DTO fields passed through correctly" } });
        }

        // GetTransactionsReport_03 | B | GetTransactionsAsync called with correct filters
        [Fact]
        public async Task Handle_WithFilters_RepoCalledWithCorrectParams()
        {
            ...
            QACollector.LogTestCase("Statistics - Transactions Report", new TestCaseDetail { FunctionGroup = "GetTransactionsReport", TestCaseID = "GetTransactionsReport_03", Description = "GetTransactionsAsync called with all filter params correctly", ExpectedResult = "Times.Once with correct params", StatusRound1 = "Passed", TestCaseType = "B", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "Search, Status, FromDate, ToDate, Page, PageSize forwarded to repo" } });
        }

        // GetTransactionsReport_04 | N | Empty result → 200 with empty PagedResult
        [Fact]
        public async Task Handle_NoTransactions_ShouldReturn200WithEmptyPage()
        {
            ...
            QACollector.LogTestCase("Statistics - Transactions Report", new TestCaseDetail { FunctionGroup = "GetTransactionsReport", TestCaseID = "GetTransactionsReport_04", Description = "No transactions → 200 with empty page", ExpectedResult = "IsSuccess=true, Items=[], TotalCount=0", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "No records in filter range" } });
        }

        // GetTransactionsReport_05 | N | PagedResult pagination metadata is correct
        [Fact]
        public async Task Handle_WithPaging_PagedMetadataIsCorrect()
        {
            ...
            QACollector.LogTestCase("Statistics - Transactions Report", new TestCaseDetail { FunctionGroup = "GetTransactionsReport", TestCaseID = "GetTransactionsReport_05", Description = "Paging: TotalCount=50, Page=3, PageSize=10 correct", ExpectedResult = "Paging metadata correct", StatusRound1 = "Passed", TestCaseType = "N", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "TotalCount=50, page 3 of 10" } });
        }

        // GetTransactionsReport_06 | A | Repository throws → exception propagates
        [Fact]
        public async Task Handle_RepoThrows_ShouldPropagateException()
        {
            ...
            QACollector.LogTestCase("Statistics - Transactions Report", new TestCaseDetail { FunctionGroup = "GetTransactionsReport", TestCaseID = "GetTransactionsReport_06", Description = "Repository throws → exception propagates", ExpectedResult = "Exception thrown", StatusRound1 = "Passed", TestCaseType = "A", TestDate = DateTime.Now.ToString("dd/MM/yyyy"), AppliedConditions = new List<string> { "GetTransactionsAsync throws" } });
        }
    }
}
